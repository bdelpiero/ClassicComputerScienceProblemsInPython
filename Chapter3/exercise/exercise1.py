...
class WordSearchConstraint(Constraint[str, List[GridLocation]]):
    ...
    def satisfied(self, assignment: Dict[str, List[GridLocation]]) -> bool:
        assigned_letters: Dict[GridLocation, str] = {}

        for word, grid_locations in assignment.items():
            for index, letter in enumerate(word):
                assigned_letter = assigned_letters.get(grid_locations[index])
                if (assigned_letter == None):
                    assigned_letters[grid_locations[index]] = letter
                    continue
...
if __name__ == "__main__":
    ...
    if solution is None:
        ...
        for word, grid_locations in solution.items():
            ...
            # can this be done with overlapping words?
